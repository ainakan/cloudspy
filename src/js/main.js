...
require(['app/views/app', 'app/presenters/app', 'app/services/messagebus', 'app/services/storage', 'app/services/settings', 'app/services/navigation', 'app/services/ospy', 'app/services/ainakan', 'lcss!css/app'], function onLoad(AppView, AppPresenter, MessageBus, Storage, Settings, Navigation, OSpy, Ainakan) {
    'use strict';
    ...
    services.ainakan = new Ainakan(services);
